...
public class GameManager2 : MonoBehaviour
{
    ...
    {
        await Task.Delay(1000);
        await  _upperHandle.SwitchTo(GameObject.Find("p_start"), 2f);
        await RenderObstacle2();
        await Task.Delay(3000);
        _speechOut.Speak("Find the bed on the wall using this handle.");
        _upperHandle.Free();
